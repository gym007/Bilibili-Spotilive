        ...
        try:
            ...
            if text.startswith("点歌"):
                ...
                if match:
                    ...
                    if self.song_request_handler:
                        await self.song_request_handler(song_name, user_guard_level, self.room_id, song_request_permission)
                    else:
            ...
            if text == "下一首":
                ...
                if self.next_request_handler:
                    await self.next_request_handler(username, self.room_id, next_request_permission)
                else:
